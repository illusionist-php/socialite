...
use Illusionist\Socialite\Contracts\Provider as ProviderContract;
...
abstract class AbstractProvider implements ProviderContract
{
     ...
     *
     * @var \Illusionist\Socialite\Two\User|null
     */
    protected $user;
     ...
     * @return array
     */
    abstract protected function getUserByToken($token, $response = []);
    ...
    /**
     * Get the approved scopes in from the token response body.
     *
     * @param  array  $response
     * @return string
     */
    protected function parseApprovedScopes($response)
    {
        return explode($this->scopeSeparator, $response['scope'] ?? '');
    }
